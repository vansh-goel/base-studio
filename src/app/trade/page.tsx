      ...
      <main className="flex-1 container mx-auto py-8 px-4">
        ...
        >
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            >
              <h2 className="text-2xl font-bold mb-4">Token Marketplace</h2>
            ...
            <AnimatePresence mode="wait">
              {selectedToken ? (
                ...
                >
                  {/* Token Header */}
                  <motion.div
                    className="flex items-center gap-6 p-6 rounded-2xl gradient-base-subtle"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.1 }}
                  >
                    <div className="w-20 h-20 rounded-2xl gradient-base flex items-center justify-center">
                      <span className="text-3xl font-bold text-white">{selectedToken.symbol.slice(0, 2)}</span>
                    </div>
                    <div className="flex-1">
                      <h2 className="text-3xl font-bold">{selectedToken.name}</h2>
                      <p className="text-lg text-muted-foreground">{selectedToken.symbol}</p>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      {/* Buy Section */}
                      <motion.div
                        className="space-y-6 p-6 rounded-xl border border-green-200 bg-green-50/50 dark:border-green-800 dark:bg-green-900/20"
                        initial={{ opacity: 0, x: -20 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.5, delay: 0.3 }}
                      >
                          ...
                          <div>
                            ...
                            <div className="flex mt-2">
                              <input
                                ...
                                className="flex-1 px-4 py-3 border border-green-300 rounded-l-lg bg-background focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                min="0.001"
                                step="0.001"
                              />
                              <div className="px-4 py-3 border border-l-0 border-green-300 rounded-r-lg bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 font-medium">
                                ETH
                              </div>
                            </div>
                      ...
                      {/* Sell Section */}
                      <motion.div
                        className="space-y-6 p-6 rounded-xl border border-red-200 bg-red-50/50 dark:border-red-800 dark:bg-red-900/20"
                        initial={{ opacity: 0, x: 20 }}
                        animate={{ opacity: 1, x: 0 }}
                          ...
                          <div>
                            ...
                            <div className="flex mt-2">
                              <input
                                ...
                                className="flex-1 px-4 py-3 border border-red-300 rounded-l-lg bg-background focus:ring-2 focus:ring-red-500 focus:border-transparent"
                                min="1"
                                step="1"
                              />
                              <div className="px-4 py-3 border border-l-0 border-red-300 rounded-r-lg bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 font-medium">
