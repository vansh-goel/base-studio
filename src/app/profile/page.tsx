...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (address) {
      ...
      const mockBasename = `creator${address.slice(2, 6)}.cb.id`;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <MinimalMobileNavbar currentPage="profile" />
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                    ...
                    {basename && (
                      <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-primary/10 border border-primary/20 w-fit">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-primary">Basename</span>
                      </div>
                    )}
                  </div>
